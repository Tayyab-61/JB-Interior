...
const navItems = [
  ...
  { name: "Manage Projects", icon: FolderKanban, href: "/projects" },
  { name: "Manage Contracts", icon: FileContract, href: "/contracts" },
  { name: "Manage Vendors", icon: Store, href: "/vendors" },
  { name: "Manage Inventory", icon: Package, href: "/inventory" },
]
